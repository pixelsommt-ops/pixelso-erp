...
export const deleteCustomer = (id) => apiClient.delete(`${BASE}/${id}`).then((res) => res.data);
export const getDormant = (params) => apiClient.get(`${BASE}/reports/dormant`, { params }).then((res) => res.data);
